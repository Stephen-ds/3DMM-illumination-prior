...
def build_renderer_diffuse(img_size, focal, kd, device):
    R, T = look_at_view_transform(50, 0, 0)  # camera's position
    ...
    diffuse_renderer = MeshRenderer(
        rasterizer=MeshRasterizer(cameras=cameras, raster_settings=raster_settings),
        shader=DiffuseEnvmap(
            device=device,
            cameras=cameras,
            envmap=None,
            materials=materials,
